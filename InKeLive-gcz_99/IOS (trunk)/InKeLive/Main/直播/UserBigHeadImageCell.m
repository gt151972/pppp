...
-(void) initUIControl {
    ...
    _userHeadImageView.frame = CGRectMake(0,0, 64, 64);
    //_userHeadImgView.backgroundColor =[UIColor redColor];
    //_userHeadImgView.image =[UIImage imageNamed:@"default_head"];
    _userHeadImageView.layer.masksToBounds = YES;
    _userHeadImageView.layer.cornerRadius = 32;
