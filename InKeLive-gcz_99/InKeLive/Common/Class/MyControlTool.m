...
+ (UIButton *)buttonWithText:(NSString *)text textColor:(UIColor *)textColor selectTextColor: (UIColor *)selectTextColor font:(NSInteger)font tag:(NSInteger)tag frame:(CGRect)frame clickBlock:(void(^)(id x))clickBlock{
