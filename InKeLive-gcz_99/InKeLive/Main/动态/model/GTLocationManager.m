...
+ (GTLocationManager *) sharedGpsManager {
    static GTLocationManager *shared = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shared = [[GTLocationManager alloc] init];
    });
    return shared;
}
...
+ (void) getMoLocationWithSuccess:(GTLocationSuccess)success Failure:(GTLocationFailed)failure {
    [[GTLocationManager sharedGpsManager] getMoLocationWithSuccess:success Failure:failure];
}
...
+ (void) stop {
    [[GTLocationManager sharedGpsManager] stop];
}
